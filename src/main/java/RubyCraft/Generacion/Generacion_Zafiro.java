...
public class Generacion_Zafiro implements IWorldGenerator{
	...
	private void generateEnd(World world, Random rand, int x, int z) {
		generateOre(Bloques.mena_de_zafiro_end, world, rand, x, z, 5,10, 6, 0, 101, Blocks.END_STONE);

		
	}

	public void generateOverWorld(World world, Random rand, int x, int z) {
    	generateOre(Bloques.mena_de_zafiro, world, rand, x, z, 4, 10, 5, 1, 20, Blocks.STONE);
	}
